...
- JSON 備份包含類別、購物管道、所有交易與訂閱關聯，可用於完整還原。
- 還原前會驗證檔案版本、ID、父子類別、收支類型及訂閱日期；驗證失敗時不會覆蓋現有資料。
- 「清除全部資料」會移除交易、訂閱、自訂類別與購物管道，然後恢復預設資料。
...
測試涵蓋資料庫建立與升級、交易 CRUD、分類與購物管道管理、月曆、分析、訂閱到期處理、搜尋篩選、備份還原，以及 320 × 640 小螢幕與放大文字的主要頁面顯示。
